...
import {Blue, Pink, Grey, LightGrey, Brown, Cream,LightBlue, Orange} from '../../utils/Constants';
import { widthPercentageToDP as wp, heightPercentageToDP as hp } from 'react-native-responsive-screen';

import {branch,iqama,Log, Signin, name, email, password, phone, Already_have_account_Login as ha, Dont_have_account_signup as dha} from '../../utils/Constants';
...
export default class Signup extends Component {
  ...
  onSignUpPress = () => {
    if( 
        ...
        Caller.callServer("addManager","POST", params)
          .then( response  => {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{height: hp('65%'), alignItems: 'center', margin: hp('1%'), padding: 10}}>
          ...
          <View style={[styles.outline,{flexDirection: 'row', paddingHorizontal: 15, alignItems: 'center'}]}>
            ...
            />
            <TextInput
              style={{flex: 1, fontSize: wp('4.5%'), padding: 7}}
          ...
          <View style={[styles.outline,{flexDirection: 'row', paddingHorizontal: 15, alignItems: 'center'}]}>
            ...
            <TextInput
              ...
              style={{flex: 1, fontSize: wp('4.5%'), padding: 7}}
              placeholder= {this.state.language=="eng" ? "IQAMA" : iqama }
              onChangeText={(val) => { this.setState({iqama: val}) }}
              placeholderTextColor={Cream}
            />
          </View>
          ...
          <View style={[styles.outline,{flexDirection: 'row', paddingHorizontal: 15, alignItems: 'center'}]}>
            ...
            <TextInput
              keyboardType={'phone-pad'}
              style={{flex: 1, fontSize: wp('4.5%'), padding: 7}}
              placeholder= {this.state.language=="eng" ? "Branch" : branch }
              onChangeText={(val) => { this.setState({branch: val}) }}
              placeholderTextColor={Cream}
            />
          </View>
